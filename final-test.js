// ============================================
// TEST FINAL - Mihais Restaurant (A2.1 · Lecția 7)
// Claudia Toth · 15 întrebări (Komparativ + Superlativ + wie/als + traducere)
// ============================================

const finalTestData = [
    // 🥈 Komparativ (4)
    { type: 'multiple', category: '🥈 Komparativ', question: 'Comparativul lui „alt" (cu Umlaut) este:', options: ['älter', 'alter', 'altere', 'am ältesten'], correct: 'älter', explanation: 'alt → älter (Umlaut a→ä). „am ältesten" e superlativul.' },
    { type: 'luckentext', category: '🥈 Komparativ', question: 'Completează comparativul (groß):', sentence: 'Mein Bruder ist <strong>______</strong> als ich.', translation: 'groß → comparativ cu Umlaut', accept: ['größer'], correct: 'größer', explanation: 'groß → größer (Umlaut o→ö).' },
    { type: 'multiple', category: '🥈 Komparativ', question: 'Care e comparativul NEREGULAT corect?', options: ['gut → besser', 'gut → guter', 'gut → güter', 'gut → am besten'], correct: 'gut → besser', explanation: 'gut → besser → am besten. Învață-l pe de rost!' },
    { type: 'luckentext', category: '🥈 Komparativ', question: 'Completează (atenție: teuer pierde un -e-):', sentence: 'Die Pizza ist <strong>______</strong> als der Salat.', translation: 'teuer → comparativ', accept: ['teurer'], correct: 'teurer', explanation: 'teuer → teurer (NU teuerer — adjectivele în -er pierd un -e-).' },

    // 🥇 Superlativ (4)
    { type: 'multiple', category: '🥇 Superlativ', question: 'Cum formezi superlativul (predicativ)?', options: ['am + adjectiv + -sten', 'der/die/das + adjectiv', 'mehr + adjectiv', 'adjectiv + als'], correct: 'am + adjectiv + -sten', explanation: 'am schnellsten, am besten, am leckersten — mereu „am ... -sten".' },
    { type: 'luckentext', category: '🥇 Superlativ', question: 'Completează superlativul (fleißig):', sentence: 'Von allen arbeitet Mihai am <strong>______</strong>.', translation: 'fleißig → superlativ', accept: ['fleißigsten'], correct: 'fleißigsten', explanation: 'fleißig → am fleißigsten.' },
    { type: 'luckentext', category: '🥇 Superlativ', question: 'Completează (atenție: +e după -t):', sentence: 'Dieser Mann ist am <strong>______</strong>.', translation: 'alt → superlativ', accept: ['ältesten'], correct: 'ältesten', explanation: 'alt → am ältesten (se adaugă -e- după -t).' },
    { type: 'multiple', category: '🥇 Superlativ', question: 'Superlativul lui „gut" este:', options: ['am besten', 'am guten', 'am gutsten', 'besser'], correct: 'am besten', explanation: 'gut → besser → am besten (neregulat).' },

    // 🔀 wie / als (3)
    { type: 'multiple', category: '🔀 wie / als', question: 'Pentru COMPARATIV (diferență: mai... decât) folosești:', options: ['als', 'wie', 'so', 'am'], correct: 'als', explanation: 'größer ALS = mai mare DECÂT. „wie" e pentru egalitate (so groß wie).' },
    { type: 'luckentext', category: '🔀 wie / als', question: 'Completează (egalitate):', sentence: 'Ich bin so alt <strong>______</strong> du.', translation: 'so alt ... (la fel de bătrân ca)', accept: ['wie'], correct: 'wie', explanation: 'so + adjectiv + wie = la fel de ... ca.' },
    { type: 'luckentext', category: '🔀 wie / als', question: 'Completează (comparativ):', sentence: 'Berlin ist größer <strong>______</strong> Potsdam.', translation: 'größer ... (mai mare decât)', accept: ['als'], correct: 'als', explanation: 'comparativ (größer) + als.' },

    // 🗣️ Context & traducere (4)
    { type: 'luckentext', category: '🗣️ Context & traducere', question: 'Completează forma corectă (so...wie → pozitiv!):', sentence: 'Der Hund ist so <strong>______</strong> wie die Katze.', translation: 'schnell — atenție: so...wie nu schimbă adjectivul', accept: ['schnell'], correct: 'schnell', explanation: 'După „so ... wie" adjectivul rămâne la POZITIV: so schnell wie.' },
    { type: 'translate', category: '🗣️ Context & traducere', question: 'Traduceți în germană:', ro: 'Pizza e mai gustoasă decât salata.', accept: ['pizza ist leckerer als salat', 'die pizza ist leckerer als der salat', 'pizza ist leckerer als der salat'], correct: 'Pizza ist leckerer als Salat.', explanation: 'leckerer (comparativ) + als (decât).' },
    { type: 'translate', category: '🗣️ Context & traducere', question: 'Traduceți în germană:', ro: 'Lasagna e cea mai bună.', accept: ['die lasagne ist am besten', 'lasagne ist am besten'], correct: 'Die Lasagne ist am besten.', explanation: 'gut → am besten (superlativ neregulat).' },
    { type: 'translate', category: '🗣️ Context & traducere', question: 'Traduceți în germană:', ro: 'Sunt la fel de înalt ca tine.', accept: ['ich bin so groß wie du'], correct: 'Ich bin so groß wie du.', explanation: 'so + groß + wie = la fel de înalt ca.' }
];
...
function buildFinalTest() {
    ...
    container.innerHTML = `
        <div id="test-intro" class="test-intro">
            ...
            <p>Test final cu <strong>${finalTestData.length} întrebări</strong> despre Komparativ și Superlativ.</p>
            <ul class="test-info-list">
                <li>🥈 Komparativ (4) · 🥇 Superlativ (4) · 🔀 wie/als (3) · 🗣️ Context & traducere (4)</li>
